...
//                        credentialsNonExpired, accountNonLocked, user.getAuthorities());
                UserDetails userDetail = (UserDetails) new User(username, user.getPassword(), enabled, accountNonExpired, credentialsNonExpired, accountNonLocked, user.getAuthorities());
